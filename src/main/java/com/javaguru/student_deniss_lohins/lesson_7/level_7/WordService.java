package com.javaguru.student_deniss_lohins.lesson_7.level_7;
...
// это всё надо заминить кодом с package com.javaguru.student_deniss_lohins.lesson_7.level_1
// и всё будет работать
//тут вообще программа возвращает просто количество, не говоря что за слово столько раз посторятось :(
/*
class WordService {
